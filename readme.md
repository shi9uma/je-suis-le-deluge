![](https://unv-shield.librian.net/api/unv_shield?txt=莉沫酱革命协议！&scale=4&anime=3)

```markdown
🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥🍥

莉沫酱革命协议 (RimoChan/Je-Suis-Le-Deluge)
版本 0x⑨
copyleft (ɔ) <YEAR> 🍥 <YOURNAME> <YOUR@EMAIL.DOMAIN>
版权所无

1. 我认为著作权法是愚蠢的且应当被废除，因此我不觉得我对这个仓库有什么权利。
    也就是说，我没有可授予你的权利。

2. 你可以对这个仓库的副本做任何事。包括但不限于
    使用、复制、修改、合并、发布、分发、再许可和/或销售本软件的副本
    你这么做的权利是你与生俱来的，而不是我授予你的。

3. 如果你真的这样做了，
    那么我得提醒你，你也许在事实上触犯了当地法律。
    但是我的良心保证了我不会起诉你，
    所以你可以根据你自己的道德判断行事。

4. 如果你觉得这个协议有意思，
    那么我会很乐意于看到你也将这个协议的思想发扬光大。
...
RimoChan Revolution License (RimoChan/Je-Suis-Le-Deluge)
Version 0x⑨
copyleft (ɔ) <YEAR> 🍥 <YOURNAME> <YOUR@EMAIL.DOMAIN>
...
2. You can do anything with copies of this repository. 
    ...
    Your right to do so is inherent, not granted by me.

3. If you really do this,
    I must remind you that
    you may in fact be violating local laws.
    But my conscience guarantees I will not sue you,
    so you can act according to your own moral judgment.

4. If you find this license interesting,
